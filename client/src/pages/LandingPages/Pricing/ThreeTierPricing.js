      ...
      <div className="mt-12 mx-32 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:items-center">
        ...
        <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
          ...
          <ul className="mt-7 space-y-2.5 text-sm">
            ...
            <li className="flex space-x-2">
            <svg className="flex-shrink-0 h-5 w-5 text-red-600" width="16" height="16" viewBox="0 0 16 16" fill="none"     xmlns="http://www.w3.org/2000/svg">
              <path d="M4.0903 4.09027L11.9098 11.9098M4.0903 11.9098L11.9098 4.09027" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
        ...
        <div className="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
          <p className="mb-3"><span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs uppercase font-semibold bg-blue-100 text-blue-800 dark:bg-blue-600 dark:text-white">Most popular</span></p>
