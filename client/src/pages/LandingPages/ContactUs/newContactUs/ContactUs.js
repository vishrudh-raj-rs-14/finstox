...
const ContactUs = () => {
  return (
    <>
      <section className=" py-20 lg:py-[200px] lg:mx-44 overflow-hidden relative z-10">
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-center">
            <div className="w-full flex items-center justify-center px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 justify-center max-w-[570px] lg:mb-0">
                ...
                Feel free to reach out to us anytime; your questions, feedback, and inquiries are important to us. Contact us
                </p>
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-indigo-600 transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
